...
CREATE TABLE `saleinfo` (
  ...
  `mnumber` varchar(255) DEFAULT NULL COMMENT '药品编号',
  `count` int DEFAULT NULL COMMENT '数量',
  `total` float(20,2) DEFAULT NULL COMMENT '金额',
  `operator` varchar(255) DEFAULT NULL COMMENT '操作人',
  `operatetime` datetime DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='销售记录';
...
INSERT INTO `saleinfo` VALUES (1,'感冒灵','00001',10,168.00,'小王','2022-09-13 16:00:00'),(2,'云南白药','00002',1,25.69,'小白','2022-09-16 16:00:00');
